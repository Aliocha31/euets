...
df_euets_fr = df_euets_account[df_euets_account["registry_id"] == "FR"]
...
# Missing VA Id
account_na = df_euets_fr["installation_id"].isna().sum()
account_len = len(df_euets_fr)
...
id_transa_na = df_euets_fr["accountIDTransactions"].isna().sum()
...
df_merge = pd.merge(df_euets_fr, df_geo_fr, on="accountIDTransactions", how="right")
